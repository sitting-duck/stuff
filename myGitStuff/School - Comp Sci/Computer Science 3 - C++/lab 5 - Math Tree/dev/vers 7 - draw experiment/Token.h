...
class Token: public RefCount
	...
	private:
		...
		//	**********	functions	**********
			...
			static  TokenState				GotO				(Token &);
			static  TokenState				Got_O_Oper			(Token &);
			static  TokenState				Got_O_Oper_Digit	(Token &);
			static  TokenState				GotSpaceAfterO		(Token &);		
