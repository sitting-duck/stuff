...
/**
* This function returns true if the iterator passed to it points to a node that "exists".
* A node that "exists" does not point to NULL or a dummy node.
* feet and head are dummy nodes.
*/
template <class T, class tree_node_allocator>
