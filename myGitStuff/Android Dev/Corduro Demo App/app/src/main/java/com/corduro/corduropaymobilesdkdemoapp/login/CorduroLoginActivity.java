...
//this is a handle to Corduro PayMobile API that is stored in the .aar file you imported into your project
import static com.corduro.corduropaymobilesdkdemoapp.CorduroPayMobileSDK.corduroPayMobileController;

//any Activity that calls any PayMobile function MUST implement the ICorduroPayMobileCallback interface.
//this essentially means that your Activity will be forced to implement a function called onRequestComplete() 
//where you can do any handling you desire with the results from your call to the Corduro server.
public class CorduroLoginActivity extends Activity implements ICorduroPayMobileCallback {
	...
	public void onClickLoginButton(View view){
		...
		//this is a CorduroPayMobile API call where you pass the necessary data to the Corduro server
		//and request to login to the Corduro network.  This is necessary for security purposes to open a session.
