...
declare const getCanonicalFileName: (filePath: string) => CanonicalPath;
...
export { ASTAndProgram, canonicalDirname, CanonicalPath, DEFAULT_COMPILER_OPTIONS, getCanonicalFileName, getTsconfigPath, };
