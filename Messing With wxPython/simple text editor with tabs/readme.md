This is a simple text editor written in wx python that features tabs and comes with a file menu and shortcuts for opening a file, saving a file, an about this editor dialog, and an exit option.
