...
public:
    ...
    void        set(float m0, float m1, float m2,   // 1st column
                    float m3, float m4, float m5,   // 2nd column
                    float m6, float m7, float m8);  // 3rd column
	void		setAt(int x, int y, float num);
...
inline void Matrix3::setAt(int x, int y, float num){
	int actualIndex = 3 * x + y;
	m[actualIndex] = num;
}

inline float Matrix3::getAt(int x, int y){
	int actualIndex = 3 * x + y;
...
inline void Matrix4::setAt(int row, int column, float num){
	int actualIndex = row + 4*column;
	m[actualIndex] = num;
}

inline float Matrix4::getAt(int row, int column){
	int actualIndex = row + 4*column;
	return m[actualIndex];
}
