1 #cp /Volumes/project/*.pb ./
 ...
 16             python -m tf2onnx.convert --graphdef ${pb_names[$pb]}-${pb_input_size[$input_in]}.pb --output ${pb_input_size[$input_in]}/model_name.onnx --inputs "input_name:0,parameter_name:0,parameter_name:0" --outputs "${outputs[$i]}"
 17         done
 18     done
 19 done
~          
